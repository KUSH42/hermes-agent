    ...
    try:
        ...
        if _terminal_cfg and isinstance(_terminal_cfg, dict):
            _terminal_env_map = {
                ...
                "output_interceptor_enabled": "TERMINAL_OUTPUT_INTERCEPTOR_ENABLED",
                "output_default_verbosity": "TERMINAL_OUTPUT_DEFAULT_VERBOSITY",
                "interceptor_persist_large_output": "TERMINAL_INTERCEPTOR_PERSIST_LARGE_OUTPUT",
                "interceptor_capture_summarized_raw": "TERMINAL_INTERCEPTOR_CAPTURE_SUMMARIZED_RAW",
                "interceptor_force_capture_background": "TERMINAL_INTERCEPTOR_FORCE_CAPTURE_BACKGROUND",
                "interceptor_force_capture_truncated": "TERMINAL_INTERCEPTOR_FORCE_CAPTURE_TRUNCATED",
                "interceptor_optional_capture_max_raw_chars": "TERMINAL_INTERCEPTOR_OPTIONAL_CAPTURE_MAX_RAW_CHARS",
                "interceptor_include_fallback_reason": "TERMINAL_INTERCEPTOR_INCLUDE_FALLBACK_REASON",
                "interceptor_persist_threshold_chars": "TERMINAL_INTERCEPTOR_PERSIST_THRESHOLD_CHARS",
                "interceptor_medium_diff_max_files": "TERMINAL_INTERCEPTOR_MEDIUM_DIFF_MAX_FILES",
                "interceptor_medium_diff_max_lines": "TERMINAL_INTERCEPTOR_MEDIUM_DIFF_MAX_LINES",
                "interceptor_min_savings_chars": "TERMINAL_INTERCEPTOR_MIN_SAVINGS_CHARS",
                "interceptor_min_savings_ratio": "TERMINAL_INTERCEPTOR_MIN_SAVINGS_RATIO",
