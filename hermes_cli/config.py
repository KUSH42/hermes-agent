...
DEFAULT_CONFIG = {
    ...
    "terminal": {
        ...
        "interceptor_force_capture_background": True,
        "interceptor_force_capture_truncated": True,
        "interceptor_optional_capture_max_raw_chars": 512,
...
def set_config_value(key: str, value: str):
    ...
    _config_to_env_sync = {
        ...
        "terminal.interceptor_force_capture_background": "TERMINAL_INTERCEPTOR_FORCE_CAPTURE_BACKGROUND",
        "terminal.interceptor_force_capture_truncated": "TERMINAL_INTERCEPTOR_FORCE_CAPTURE_TRUNCATED",
        "terminal.interceptor_optional_capture_max_raw_chars": "TERMINAL_INTERCEPTOR_OPTIONAL_CAPTURE_MAX_RAW_CHARS",
