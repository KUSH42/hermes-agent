...
x-hermes:
  ...
  component-vars:
    ...
    running-indicator-dim-color: '#b8860b'
    fps-hud-bg: '#1a1a2e'
    ...
    brand-glyph-color: '#FFBF00'
    scrollbar: '#5f87d7'
    drawbraille-canvas-color: '#ffbf00'
    panel-border: '#333333'
    ...
    diff-del-bg: '#3a1a1a'
    info: '#58A6FF'
    nameplate-idle-color: '#555555'
    nameplate-active-color: '#FFD700'
    nameplate-decrypt-color: '#FFA726'
    spinner-shimmer-dim: '#b8860b'
    spinner-shimmer-peak: '#fff8dc'
    ...
    thinking-spinner-dim: '#b8860b'
    thinking-spinner-peak: '#fff8dc'
