...
x-hermes:
  ...
  component-vars:
    ...
    running-indicator-dim-color: '#153c73'
    fps-hud-bg: '#1a1a2e'
    ...
    brand-glyph-color: '#5DB8F5'
    scrollbar: '#5f87d7'
    drawbraille-canvas-color: '#5db8f5'
    panel-border: '#333333'
    ...
    diff-del-bg: '#3a1a1a'
    info: '#58A6FF'
    nameplate-idle-color: '#1E4A6E'
    nameplate-active-color: '#7FD8FF'
    nameplate-decrypt-color: '#26C6DA'
    spinner-shimmer-dim: '#153c73'
    spinner-shimmer-peak: '#eaf7ff'
    ...
    thinking-spinner-dim: '#153c73'
    thinking-spinner-peak: '#eaf7ff'
