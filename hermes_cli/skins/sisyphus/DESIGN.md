...
x-hermes:
  ...
  component-vars:
    ...
    running-indicator-hi-color: '#b7b7b7'
    running-indicator-dim-color: '#4a4a4a'
    fps-hud-bg: '#1a1a2e'
    ...
    scrollbar: '#5f87d7'
    drawbraille-canvas-color: '#e7e7e7'
    panel-border: '#333333'
    ...
    spinner-shimmer-dim: '#4a4a4a'
    spinner-shimmer-peak: '#f5f5f5'
