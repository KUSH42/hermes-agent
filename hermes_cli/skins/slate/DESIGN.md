...
x-hermes:
  ...
  component-vars:
    ...
    running-indicator-hi-color: '#e6a855'
    running-indicator-dim-color: '#4b5563'
    fps-hud-bg: '#1a1a2e'
    ...
    scrollbar: '#5f87d7'
    drawbraille-canvas-color: '#7eb8f6'
    panel-border: '#333333'
