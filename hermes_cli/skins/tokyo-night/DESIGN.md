...
colors:
  ...
  banner-text: '#c0caf5'
  banner-warning: '#ff9e64'
  banner-warning-dim: '#b36e45'
  banner-key: '#e0af68'
  input-rule: '#7aa2f7'
  prompt: '#bb9af7'
...
x-hermes:
  ...
  component-vars:
    ...
    attachment-chip-bg: '#1a1b26'
    attachment-chip-shimmer-dim: '#444b6a'
    attachment-chip-shimmer-peak: '#c0caf5'
    ...
    thinking-spinner-dim: '#444b6a'
    thinking-spinner-peak: '#c0caf5'
