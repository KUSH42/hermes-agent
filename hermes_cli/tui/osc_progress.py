...
def osc_progress_start() -> None:
    ...
    except Exception:  # il-ex-1-exempt: stdout write failed (closed fd or unsupported) — OSC progress skipped
        pass
...
def osc_progress_end() -> None:
    ...
    except Exception:  # il-ex-1-exempt: stdout write failed (closed fd or unsupported) — OSC clear skipped
        pass
