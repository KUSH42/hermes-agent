...
class ToolGroup(Widget):
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        # STALL-GC: monotonic timestamp when _group_state first entered a terminal state.
        # 0.0 means not yet terminal.
        self._group_terminal_at: float = 0.0
    ...
    def on_tool_panel_completed(self, event: object) -> None:
        ...
        try:
            ...
            # STALL-GC-H1/H2: record first terminal transition; schedule abandonment sweep.
