...
class TestCodeBlocks:
    ...
    def test_mermaid_render_callback_logs_exc_info(self):
        ...
        class _IsolatedCodeBlock(StreamingCodeBlock):
            @property
            def is_mounted(self):
                return False
        ...
        block = _IsolatedCodeBlock.__new__(_IsolatedCodeBlock)
        block._lang = "mermaid"
    ...
    def test_mermaid_subprocess_logs_exc_info(self):
        ...
        class _IsolatedMountedCodeBlock(StreamingCodeBlock):
            @property
            def is_mounted(self):
                return True
        ...
        block = _IsolatedMountedCodeBlock.__new__(_IsolatedMountedCodeBlock)
        block._lang = "mermaid"
        block._code_lines = ["graph TD", "    A-->B"]
        block._complete_skin_vars = {}
        block._collapsed = False
...
class TestMedia:
    ...
    def test_media_widget_load_logs_error(self):
        ...
        class _IsolatedInlineMediaWidget(InlineMediaWidget):
            @property
            def is_mounted(self):
                return True
        ...
        widget = _IsolatedInlineMediaWidget.__new__(_IsolatedInlineMediaWidget)
...
class TestOverlaysWidget:
    ...
    def test_overlays_content_switcher_toggle_logs_error(self):
        ...
        class _IsolatedHistorySearchOverlay(HistorySearchOverlay):
            @property
            def app(self):
                return mock_app

        overlay = _IsolatedHistorySearchOverlay.__new__(_IsolatedHistorySearchOverlay)
